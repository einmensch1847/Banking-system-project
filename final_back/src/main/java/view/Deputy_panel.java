...
public class Deputy_panel extends VBox{
    ...
    public Deputy_panel() throws FileNotFoundException {
        ...
        Label Alabel1 = new Label("Bank deputy has access to all program features") ;
        ...
        VBox vBox3 = new VBox(getName_of_bank_ceo_button(), getName_of_bank_deputy_button(), getName_of_admin_button()) ;
        vBox3.setSpacing(20);
        vBox3.setAlignment(Pos.CENTER);

        setChange_name_of_bank_deputy_button(new Button("change name of bank deputy"));
        ...
        HBox hBox1 = new HBox(getChange_name_of_bank_deputy_button(),Exit_button) ;
        hBox1.setAlignment(Pos.CENTER);
        hBox1.setSpacing(20);

        HBox hBox2 = new HBox(vBox1 , vBox2 , vBox3) ;
        ...
        this.setSpacing(20);
        this.getChildren().addAll(einmenschlabel ,Alabel1 , hBox2 , hBox1 ) ;
    }
